      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="inputPatronymic" required>
          </div>
          <div class="mb-3">
            <label for="inputBirthYear" class="form-label">Год рождения</label>
            <input type="text" class="form-control" id="inputBirthYear" required>
          </div>
          <div class="mb-3">
            <label for="inputPassportNumber" class="form-label">Номер паспорта</label>
            <input type="text" class="form-control" id="inputPassportNumber" required>
          </div>
          <div class="mb-3">
            <label for="inputPassportIssueDate" class="form-label">Дата выдачи паспорта</label>
            <input type="text" class="form-control" id="inputPassportIssueDate" required>
          </div>
